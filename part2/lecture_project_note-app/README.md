...
Follow these steps to run the application:
    ...
    Clone this repository to your own machine with the command git clone https://github.com/fullstack-hy2020/part2-notes-frontend.git

    Navigate to the cloned repository with the command cd part2-notes-frontend
